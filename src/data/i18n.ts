...
export const uiTranslations = {
  en: {
    ...
    common: {
      ...
      footerUpdated: 'Scavland Wiki Database updated September 2026 · Community-maintained baseline.',
    },
  },
  ru: {
    ...
    common: {
      ...
      mediaCaption: 'Материалы: верифицированные игровые данные и ассеты Scavland.',
      footerDisclaimer: 'Независимая вики сообщества с проверенными тактическими данными. Не аффилирована с NoShadow.',
      footerUpdated: 'База знаний Scavland обновлена в сентябре 2026 года · Данные сообщества.',
    },
  },
  de: {
    ...
    common: {
      ...
      mediaCaption: 'Medien: Verifiziertes autorisiertes Asset-Paket · Datenbasis.',
  ...
  ja: {
    ...
    common: {
      ...
      mediaCaption: 'メディア: 検証済みゲームデータおよびアセット。',
      footerDisclaimer: '有志による非公式ファン攻略Wikiです。ゲームデータはコミュニティ検証済みの情報に基づきます。NoShadowとは提携していません。',
      footerUpdated: 'Scavland Wiki 攻略データベース 2026年9月更新 · コミュニティ検証データ。',
    },
  },
};
