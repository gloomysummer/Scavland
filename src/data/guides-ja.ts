...
'03 · 敵対化の回避：不用意に派閥の検問所を攻撃すると評判が大幅ダウン。-300以下で即座に銃撃されるため注意。',
  ...
  },
  {
    ...
    evidence: '早期アクセス パッチ v0.6.0 実機検証済み',
    updated: '2026-09-15',
  ...
  },
  {
    ...
    evidence: '早期アクセス最新パッチ v0.6.0 実機検証済み',
    updated: '2026-09-16',
    ...
    steps: [
      ...
      '02 · 商人の専門分野で売却価格を最大化：スパークプラグ（450ルーブル）やリレーはアナトリーに売却。専門外の商人に売ると50%の減額ペナルティが発生します。',
      '03 · 重量対価格（ルーブル/kg）を重視：車のバッテリーのような重量物よりも、スパークプラグ（0.3kg）やライター（0.1kg）など1マス高単価品を優先。',
    ...
    facts: [
      ...
      ['最高峰の換金効率', 'スパークプラグ（450R/0.3kg）や軍用ライター（320R/0.1kg）は1kgあたり1,500R以上'],
