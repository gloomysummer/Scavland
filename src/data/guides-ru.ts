...
export const ruGuides: Guide[] = [
  ...
  },
  {
    ...
    evidence: 'Совместимость со Steam Deck по данным сообщества',
    updated: '2026-09-07',
  ...
  },
  {
    ...
    steps: [
      ...
      '03 · Блокировка бункеров: Подземные военные комплексы (бункер Б-4) не возрождают лут сразу после сна, требуя времени на перезагрузку инстанса.',
      ...
      '05 · Комендантский час (21:00): Ночью дальность обзора падает до 10 метров, а звуки выстрелов привлекают стаи за 200 метров. Выходите в рейд на рассвете и возвращайтесь до сумерек.'
    ],
    facts: [
    ...
    faq: [
      ...
      ['Почему после сна не восстанавливается выносливость?', 'Это вызвано скрытым дебаффом "Тяжелое обезвоживание". Выпейте кипяченой воды и отдохните у зажженного костра.'],
      ['Респаунится ли лут в подземных бункерах после сна?', 'Нет. Подземные бункеры имеют длительный внутренний таймер восстановления, чтобы исключить бесконечный фарм редкого оружия.']
    ],
  ...
  },
  {
    ...
    answer: 'Грамотное использование медикаментов и припасов в Scavland определяет шанс выживания в рейдах Залесья. Кровотечения необходимо останавливать до применения аптечек, а обезвоживание блокирует восстановление выносливости после сна.',
    steps: [
      ...
      '02 · Остановка кровотечений перед лечением: Артериальное кровотечение сжигает до 5 HP/сек. Назначьте бинты или гемостатическую губку на слот [5].',
      '03 · Наложение шин при переломах: Падения и выстрелы вызывают переломы (-40% скорости, +60% раскачки оружия). Деревянная шина мгновенно снимает штраф.',
      '04 · Вывод радиации: При желтом уровне заражения принимайте таблетки активированного угля. Армейские шприцы Рад-Эвэй берегите для плотного Тумана.',
      '05 · Боевые стимуляторы и калории: Тушенка и сухпайки восстанавливают базовую шкалу сил. Энергетики дают +10 кг переносимого веса для спринта до эвакуации.'
    ],
    facts: [
  ...
  },
  {
    ...
    steps: [
      ...
      'Быстрый лут через Shift+Click: В опасных зонах зажимайте [Shift + ЛКМ] для мгновенного перемещения стопок предметов из контейнеров в рюкзак.',
      'Резерв в схроне: Храните в несгораемом ящике Залесья запас из 10 пружин и 20 металлолома для ремонта оружия, а бытовой хлам сразу превращайте в рубли.'
    ],
    facts: [
    ...
    faq: [
      ...
      ['Кому выгоднее всего продавать электронику и запчасти?', 'Анатолию в Залесье или торговцам фракции Механиков. Продажа оружейнику Петару или доктору Анне облагается 50% штрафом.'],
